...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loan_Extension.extension_months'
        db.add_column('loan_loan_extension', 'extension_months',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loan_Extension.extension_months'
        db.delete_column('loan_loan_extension', 'extension_months')
