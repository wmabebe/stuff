...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan_Disbursement.last_payment'
        db.delete_column('loan_loan_disbursement', 'last_payment')

        # Adding field 'Loan_Disbursement.last_payment_amount'
        db.add_column('loan_loan_disbursement', 'last_payment_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Loan_Disbursement.last_payment'
        db.add_column('loan_loan_disbursement', 'last_payment',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

        # Deleting field 'Loan_Disbursement.last_payment_amount'
        db.delete_column('loan_loan_disbursement', 'last_payment_amount')
