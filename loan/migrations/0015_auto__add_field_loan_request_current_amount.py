...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loan_Request.current_amount'
        db.add_column('loan_loan_request', 'current_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=5000, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loan_Request.current_amount'
        db.delete_column('loan_loan_request', 'current_amount')
    ...
    models = {
        ...
        'loan.loan_request': {
            ...
            'current_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'guaranteed': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
