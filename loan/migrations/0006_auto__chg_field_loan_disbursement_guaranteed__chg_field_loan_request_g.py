...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('loan_loan_disbursement', 'guaranteed', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Loan_Request.guaranteed'
        db.alter_column('loan_loan_request', 'guaranteed', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Loan_Disbursement.guaranteed'
        db.alter_column('loan_loan_disbursement', 'guaranteed', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'Loan_Request.guaranteed'
        db.alter_column('loan_loan_request', 'guaranteed', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        'loan.loan_disbursement': {
            ...
            'guaranteed': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
