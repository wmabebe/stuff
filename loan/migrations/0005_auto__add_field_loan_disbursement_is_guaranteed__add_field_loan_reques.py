...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loan_Disbursement.is_guaranteed'
        db.add_column('loan_loan_disbursement', 'is_guaranteed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Loan_Request.is_guaranteed'
        db.add_column('loan_loan_request', 'is_guaranteed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loan_Disbursement.is_guaranteed'
        db.delete_column('loan_loan_disbursement', 'is_guaranteed')

        # Deleting field 'Loan_Request.is_guaranteed'
        db.delete_column('loan_loan_request', 'is_guaranteed')
