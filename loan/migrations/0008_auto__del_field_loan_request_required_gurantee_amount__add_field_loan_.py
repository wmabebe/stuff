...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan_Request.required_gurantee_amount'
        db.delete_column('loan_loan_request', 'required_gurantee_amount')

        # Adding field 'Loan_Request.required_guarantee_amount'
        db.add_column('loan_loan_request', 'required_guarantee_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Loan_Request.required_gurantee_amount'
        db.add_column('loan_loan_request', 'required_gurantee_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Loan_Request.required_guarantee_amount'
        db.delete_column('loan_loan_request', 'required_guarantee_amount')
    ...
    models = {
        ...
        'loan.loan_request': {
            ...
            'required_guarantee_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'seen_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
        'members.member': {
