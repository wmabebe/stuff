...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loan_Extension.seen_date'
        db.alter_column('loan_loan_extension', 'seen_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Loan_Extension.seen_date'
        db.alter_column('loan_loan_extension', 'seen_date', self.gf('django.db.models.fields.DateField')(default=None))
