...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guarantee.applied_amount'
        db.add_column('loan_guarantee', 'applied_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guarantee.applied_amount'
        db.delete_column('loan_guarantee', 'applied_amount')
