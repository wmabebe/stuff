...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loan_Disbursement.settlement_date'
        db.add_column('loan_loan_disbursement', 'settlement_date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loan_Disbursement.settlement_date'
        db.delete_column('loan_loan_disbursement', 'settlement_date')
