...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guarantee.created_date'
        db.add_column('loan_guarantee', 'created_date',
        ...
        db.alter_column('loan_guarantee', 'percentage', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Guarantee.created_date'
        db.delete_column('loan_guarantee', 'created_date')
        ...
        # Changing field 'Guarantee.percentage'
        db.alter_column('loan_guarantee', 'percentage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
