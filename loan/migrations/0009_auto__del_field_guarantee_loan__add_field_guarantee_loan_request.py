...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Guarantee.loan_request'
        db.add_column('loan_guarantee', 'loan_request',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Guarantee.loan_request'
        db.delete_column('loan_guarantee', 'loan_request_id')
