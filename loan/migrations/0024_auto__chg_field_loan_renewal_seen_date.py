...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loan_Renewal.seen_date'
        db.alter_column('loan_loan_renewal', 'seen_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Loan_Renewal.seen_date'
        db.alter_column('loan_loan_renewal', 'seen_date', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        'loan.guarantee': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
