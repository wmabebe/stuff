...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Guarantee.seen_date'
        db.alter_column('loan_guarantee', 'seen_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Guarantee.amount'
        db.alter_column('loan_guarantee', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Guarantee.percentage'
        db.alter_column('loan_guarantee', 'percentage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Guarantee.seen_date'
        db.alter_column('loan_guarantee', 'seen_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Guarantee.amount'
        db.alter_column('loan_guarantee', 'amount', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'Guarantee.percentage'
        db.alter_column('loan_guarantee', 'percentage', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=4, decimal_places=2))
    ...
    models = {
        'loan.guarantee': {
            ...
            'percentage': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
