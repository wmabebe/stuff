...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan_Request.requires_adjustment'
        db.delete_column('loan_loan_request', 'requires_adjustment')

        # Adding field 'Loan_Request.required_adjustment'
        db.add_column('loan_loan_request', 'required_adjustment',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Loan_Request.requires_adjustment'
        db.add_column('loan_loan_request', 'requires_adjustment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Loan_Request.required_adjustment'
        db.delete_column('loan_loan_request', 'required_adjustment')
    ...
    models = {
        'loan.guarantee': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'}),
