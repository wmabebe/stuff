...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account_Transaction.amount'
        db.delete_column('transactions_account_transaction', 'amount')

        # Adding field 'Account_Transaction.paid_amount'
        db.add_column('transactions_account_transaction', 'paid_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Account_Transaction.amount'
        db.add_column('transactions_account_transaction', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Account_Transaction.paid_amount'
        db.delete_column('transactions_account_transaction', 'paid_amount')
