...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loan_Transaction.payment_type'
        db.add_column('transactions_loan_transaction', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(default='procedural', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loan_Transaction.payment_type'
        db.delete_column('transactions_loan_transaction', 'payment_type')
    ...
    models = {
        ...
        'transactions.loan_transaction': {
            ...
            'paid_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '2'}),
            'payment_type': ('django.db.models.fields.CharField', [], {'default': "'procedural'", 'max_length': '50'}),
