...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Loan_Transaction'
        db.create_table('transactions_loan_transaction', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 19, 0, 0))),
            ('paid_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('total', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('extended_from', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('extended_to', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('renewed_from', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('renewed_to', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('is_settled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('transactions', ['Loan_Transaction'])

        # Adding model 'Account_Transaction'
        db.create_table('transactions_account_transaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['balance_and_dividend.Savings_Account'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 19, 0, 0))),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('total', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal('transactions', ['Account_Transaction'])


    def backwards(self, orm):
        # Deleting model 'Loan_Transaction'
        db.delete_table('transactions_loan_transaction')

        # Deleting model 'Account_Transaction'
        db.delete_table('transactions_account_transaction')
