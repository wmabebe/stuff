...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.registration_date'
        db.alter_column('members_member', 'registration_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Member.registration_date'
        db.alter_column('members_member', 'registration_date', self.gf('django.db.models.fields.DateField')(default=None))
