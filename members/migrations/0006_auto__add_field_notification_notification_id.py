...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.notification_id'
        db.add_column('members_notification', 'notification_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.notification_id'
        db.delete_column('members_notification', 'notification_id')
