...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.member_id'
        db.alter_column('members_member', 'member_id', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Member.member_id'
        db.alter_column('members_member', 'member_id', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        'members.member': {
            ...
            'member_id': ('django.db.models.fields.CharField', [], {'default': "'mem-<built-in function id>'", 'max_length': '20'}),
