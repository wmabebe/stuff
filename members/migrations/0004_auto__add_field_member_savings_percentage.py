...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.savings_percentage'
        db.add_column('members_member', 'savings_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default=5, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.savings_percentage'
        db.delete_column('members_member', 'savings_percentage')
