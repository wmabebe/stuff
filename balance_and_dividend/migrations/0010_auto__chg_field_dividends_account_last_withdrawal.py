...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dividends_Account.last_withdrawal'
        db.alter_column('balance_and_dividend_dividends_account', 'last_withdrawal', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Dividends_Account.last_withdrawal'
        db.alter_column('balance_and_dividend_dividends_account', 'last_withdrawal', self.gf('django.db.models.fields.DateField')(default=None))
