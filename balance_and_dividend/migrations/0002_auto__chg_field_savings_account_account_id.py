...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Savings_Account.account_id'
        db.alter_column('balance_and_dividend_savings_account', 'account_id', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Savings_Account.account_id'
        db.alter_column('balance_and_dividend_savings_account', 'account_id', self.gf('django.db.models.fields.CharField')(max_length=10))
