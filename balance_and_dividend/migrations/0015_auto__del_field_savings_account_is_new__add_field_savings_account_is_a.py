...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Savings_Account.is_new'
        db.delete_column('balance_and_dividend_savings_account', 'is_new')

        # Adding field 'Savings_Account.is_active'
        db.add_column('balance_and_dividend_savings_account', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Savings_Account.is_new'
        db.add_column('balance_and_dividend_savings_account', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Savings_Account.is_active'
        db.delete_column('balance_and_dividend_savings_account', 'is_active')
    ...
    models = {
        'balance_and_dividend.dividend': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 17, 0, 0)'}),
        ...
        'balance_and_dividend.dividends_account': {
            ...
            'last_withdrawal': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'withdrawn': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '2'})
        },
        ...
        'members.member': {
            ...
            'application_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 17, 0, 0)'}),
