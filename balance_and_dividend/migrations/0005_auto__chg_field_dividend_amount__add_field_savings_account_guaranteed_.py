...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Savings_Account.guaranteed'
        db.add_column('balance_and_dividend_savings_account', 'guaranteed',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Dividend.amount'
        db.alter_column('balance_and_dividend_dividend', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
        # Deleting field 'Savings_Account.guaranteed'
        db.delete_column('balance_and_dividend_savings_account', 'guaranteed')


        # Changing field 'Savings_Account.deposit'
        db.alter_column('balance_and_dividend_savings_account', 'deposit', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Savings_Account.interest'
        db.alter_column('balance_and_dividend_savings_account', 'interest', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Savings_Account.balance'
        db.alter_column('balance_and_dividend_savings_account', 'balance', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        'balance_and_dividend.savings_account': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {}),
            'deposit': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
