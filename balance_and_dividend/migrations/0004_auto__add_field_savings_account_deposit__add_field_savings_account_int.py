...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Savings_Account.deposit'
        db.add_column('balance_and_dividend_savings_account', 'deposit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Savings_Account.interest'
        db.add_column('balance_and_dividend_savings_account', 'interest',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


        # Changing field 'Savings_Account.last_deposit'
        db.alter_column('balance_and_dividend_savings_account', 'last_deposit', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Savings_Account.deposit'
        db.delete_column('balance_and_dividend_savings_account', 'deposit')

        # Deleting field 'Savings_Account.interest'
        db.delete_column('balance_and_dividend_savings_account', 'interest')


        # Changing field 'Savings_Account.last_deposit'
        db.alter_column('balance_and_dividend_savings_account', 'last_deposit', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'balance_and_dividend.savings_account': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
