...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dividends_Account.withdrawn'
        db.add_column('balance_and_dividend_dividends_account', 'withdrawn',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dividends_Account.withdrawn'
        db.delete_column('balance_and_dividend_dividends_account', 'withdrawn')
    ...
    models = {
        ...
        'balance_and_dividend.dividends_account': {
            ...
            'withdrawn': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'})
        },
